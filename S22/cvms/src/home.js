...
export function loadModule(smid)
{
    ...
    switch(smid)
    {
        ...
        case "M00201":
                module.src = "/vote";
                titlebar.innerText = "Vote";
                break;
        case "M00102":
                module.src = "/report";
                titlebar.innerText = "Report";
                break;
        case "M10003":
                module.src = "/feedback";
                titlebar.innerText = "Give Feedback";
                break;
        default:
            module.src="";
            titlebar.innerText="";
        ...
        return(
            <div className='fullheight'>
                <div className='header'>
                    <label style={titlestyle}>KL University | Online Voting System</label>
                ...
                <div className='footer'>Copyright @ Myvote. All rights reserved.</div>
            </div>
        );
    }
}
